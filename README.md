...
We recommend using [Carthage](https://github.com/Carthage/Carthage) to add ReactiveCocoa to your project. Simply install Carthage and add RAC:

```sh
echo 'github "ReactiveCocoa/ReactiveCocoa"' >> Cartfile
carthage update
```
