...
// Adds the given command to the button. The command's `canExecuteValue` controls the button's enabledness. The command's `-canExecute:` and `-execute:` are passed the action's sender.
