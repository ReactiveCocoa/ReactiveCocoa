...
@property (nonatomic, strong) RACObservableValue *dontMatchObservable;
...
- (void)applicationDidFinishLaunching:(NSNotification *)notification {
	...
	self.dontMatchObservable = [RACObservableValue valueWithValue:[NSNumber numberWithBool:YES]];
	...
	[self.matchesLabel bind:NSHiddenBinding toObject:self withKeyPath:RACKVO(self.dontMatchObservable.value)];
...
@synthesize dontMatchObservable;
