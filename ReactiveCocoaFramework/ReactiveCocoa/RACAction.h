...
/// a -deferred: execution is subscribed to. Each inner signal will replay the
/// results of the execution, including any `error` or `completed` event.
///
/// If a subscription to -deferred: is disposed, the corresponding inner signal
/// from this signal will send `completed` (to prevent subscriptions from living
/// forever).
///
...
/// -execute: and -deferred: will be ignored.
- (RACAction *)action;
