...
// The operation queue on which the async block should be executed. By default, this is an operation queue with max concurrent operations set to NSOperationQueueDefaultMaxConcurrentOperationCount.
...
//
// block - a new block to perform when the command is executed. Cannot be nil. The value it is passed is the value given to the command's -execute: call.
