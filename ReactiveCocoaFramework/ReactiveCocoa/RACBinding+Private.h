...
//              the binding that triggered the change, or `nil` if the change
//              was triggered by other means. The signal must also send a
...
//              value, the second element will be the binding that triggered the
//              change or nil if the change was triggered by the property
//              itself.
