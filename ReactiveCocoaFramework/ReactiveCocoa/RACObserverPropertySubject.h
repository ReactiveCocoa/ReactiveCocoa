...
#define _RACBindObject(OBJ, KEYPATH) [RACObserverPropertySubject propertyWithTarget:OBJ keyPath:@keypath(OBJ, KEYPATH)][ @"binding" ]
...
@interface RACObserverPropertySubject : RACPropertySubject
