...
- (void)subscribeSavingDisposable:(void (^)(RACDisposable *diposable))saveDisposableBlock next:(void (^)(id x))nextBlock error:(void (^)(NSError *error))errorBlock completed:(void (^)(void))completedBlock;
