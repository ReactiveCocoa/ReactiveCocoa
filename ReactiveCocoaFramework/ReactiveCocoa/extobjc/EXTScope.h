...
#define onExit \
    try {} @finally {} \
    __strong ext_cleanupBlock_t metamacro_concat(ext_exitBlock_, __LINE__) __attribute__((cleanup(rac_executeCleanupBlock), unused)) = ^
...
static inline void rac_executeCleanupBlock (__strong ext_cleanupBlock_t *block) {
    (*block)();
}
