#
#  Be sure to run `pod spec lint Rex.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Bjarke Hesthaven Søndergaard"
  # s.authors            = { "Bjarke Hesthaven Søndergaard" => "bhs@trifork.com" }
  # s.social_media_url   = "http://twitter.com/Bjarke Hesthaven Søndergaard"
